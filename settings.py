...
BROWNIE_ATELIER_NOTICE__SMTP_HOST: str = str(config("BROWNIE_ATELIER_NOTICE__SMTP_HOST", default=""))
BROWNIE_ATELIER_NOTICE__SMTP_PORT: int = int(config("BROWNIE_ATELIER_NOTICE__SMTP_PORT", default=0))
BROWNIE_ATELIER_NOTICE__FROM_EMAIL: str = str(config("BROWNIE_ATELIER_NOTICE__FROM_EMAIL", default=""))
BROWNIE_ATELIER_NOTICE__TO_EMAIL: str = str(config("BROWNIE_ATELIER_NOTICE__TO_EMAIL", default=""))
BROWNIE_ATELIER_NOTICE__PASSWORD: str = str(config("BROWNIE_ATELIER_NOTICE__PASSWORD", default=""))
...
BROWNIE_ATELIER_NOTICE__SLACK_TOKEN: str = str(config("BROWNIE_ATELIER_NOTICE__SLACK_TOKEN", default=""))
